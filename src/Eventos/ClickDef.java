...
public class ClickDef implements Listener
{
    ...
    public void onClickItem4(final PlayerInteractEvent e) {
        ...
        if ((e.getAction() == Action.RIGHT_CLICK_AIR || e.getAction() == Action.RIGHT_CLICK_BLOCK) && e.getPlayer().getItemInHand().getType() == Material.PISTON_STICKY_BASE) {
            e.setCancelled(true);
    ...
    public void onClickItem401(final PlayerInteractEvent e) {
        final Player p = e.getPlayer();
        if ((e.getAction() == Action.RIGHT_CLICK_AIR || e.getAction() == Action.RIGHT_CLICK_BLOCK) && e.getPlayer().getItemInHand().getType() == Material.REDSTONE) {
            e.setCancelled(true);
            p.playSound(p.getLocation(), Sound.DOOR_OPEN, 5.0f, 5.0f);
            InvOutros.guiKits(p);
        }
    ...
    public void onClickItem412(final PlayerInteractEvent e) {
        final Player p = e.getPlayer();
        if ((e.getAction() == Action.RIGHT_CLICK_AIR || e.getAction() == Action.RIGHT_CLICK_BLOCK) && e.getPlayer().getItemInHand().getType() == Material.BOOK) {
            e.setCancelled(true);
            p.playSound(p.getLocation(), Sound.DOOR_OPEN, 5.0f, 5.0f);
            InvLoja.guiKits(p);
        }
