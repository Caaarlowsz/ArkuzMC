...
public class Limpar implements CommandExecutor, Listener
{
    ...
    public boolean onCommand(final CommandSender Sender, final Command Cmd, final String Label, final String[] Args) {
        ...
        if (Cmd.getName().equalsIgnoreCase("limpar")) {
            ...
            Bukkit.broadcastMessage("§cExecutando limpeza do servidor, isto pode causar LAG, mas ser\u00e1 temporario!");
            ...
            for (int length = (onlinePlayers = Bukkit.getOnlinePlayers()).length, i = 0; i < length; ++i) {
                ...
                if (s.hasPermission("arkuz.limpar")) {
                    s.sendMessage("§a§l!§7 Foram removidos §6" + Long.toString(Lused2 - Lused3) + "M §7RAM do Servidor");
                }
            }
        }
