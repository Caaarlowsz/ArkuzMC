...
public class SetArena implements Listener, CommandExecutor
{
    ...
    public boolean onCommand(final CommandSender sender, final Command cmd, final String label, final String[] args) {
        ...
        if (p.hasPermission("arkuz.setarena") && label.equalsIgnoreCase("setarena")) {
            if (args.length == 0) {
                p.sendMessage(String.valueOf(Main.prefix) + " §4\u27bc §7Use: /SetArena {1-7}");
                return true;
            }
            if (args[0].equalsIgnoreCase("1")) {
                Main.getPlugin().getConfig();
                p.sendMessage(String.valueOf(Main.prefix) + " §4\u27bc §7A Arena 1 Foi Setada Com Sucesso");
            ...
            if (args[0].equalsIgnoreCase("2")) {
                Main.getPlugin().getConfig();
                p.sendMessage(String.valueOf(Main.prefix) + " §4\u27bc §7A Arena 2 Foi Setada Com Sucesso");
            ...
            if (args[0].equalsIgnoreCase("3")) {
                Main.getPlugin().getConfig();
                p.sendMessage(String.valueOf(Main.prefix) + " §4\u27bc §7A Arena 3 Foi Setada Com Sucesso");
            ...
            if (args[0].equalsIgnoreCase("4")) {
                Main.getPlugin().getConfig();
                p.sendMessage(String.valueOf(Main.prefix) + " §4\u27bc §7A Arena 4 Foi Setada Com Sucesso");
            ...
            if (args[0].equalsIgnoreCase("5")) {
                Main.getPlugin().getConfig();
                p.sendMessage(String.valueOf(Main.prefix) + " §4\u27bc §7A Arena 5 Foi Setada Com Sucesso");
            ...
            if (args[0].equalsIgnoreCase("6")) {
                Main.getPlugin().getConfig();
                p.sendMessage(String.valueOf(Main.prefix) + " §4\u27bc §7A Arena 6 Foi Setada Com Sucesso");
            ...
            if (args[0].equalsIgnoreCase("7")) {
                Main.getPlugin().getConfig();
                p.sendMessage(String.valueOf(Main.prefix) + " §4\u27bc §7A Arena 7 Foi Setada Com Sucesso");
