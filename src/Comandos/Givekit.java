...
public class Givekit implements CommandExecutor, Listener
{
    public boolean onCommand(final CommandSender sender, final Command cmd, final String label, final String[] args) {
        ...
        if (cmd.getName().equalsIgnoreCase("givekit")) {
            ...
            if (args.length == 0) {
                p.sendMessage(String.valueOf(Main.prefix) + "\u279c §cOps! Use isso De Maneira Correta: §f/givekit <jogador> <kit>");
                return true;
            }
            final int length = args.length;
            if (args.length != 2) {
                p.sendMessage(String.valueOf(Main.prefix) + "\u279c §cOps! Use isso De Maneira Correta: §f/givekit <nick> <kit>");
                return true;
            }
            final String kit = args[1];
            final Player jogador = Bukkit.getPlayer(args[0]);
            if (kit.equalsIgnoreCase("Boxer")) {
                p.sendMessage("§eO Kit §bBOXER §eFoi dado ao jogador " + jogador.getName() + "§e(" + jogador.getUniqueId() + "§e)");
            ...
            if (kit.equalsIgnoreCase("Ajnin")) {
                p.sendMessage("§eO Kit §bAJNIN §eFoi dado ao jogador " + jogador.getName() + "§e(" + jogador.getUniqueId() + "§e)");
            ...
            if (kit.equalsIgnoreCase("Switcher")) {
                p.sendMessage("§eO Kit §bSWITCHER §eFoi dado ao jogador " + jogador.getName() + "§e(" + jogador.getUniqueId() + "§e)");
            ...
            if (kit.equalsIgnoreCase("Thresh")) {
                p.sendMessage("§eO Kit §bTHRESH §eFoi dado ao jogador " + jogador.getName() + "§e(" + jogador.getUniqueId() + "§e)");
            ...
            if (kit.equalsIgnoreCase("BurstMaster")) {
                p.sendMessage("§eO Kit §bBUSRSTMASTER §eFoi dado ao jogador " + jogador.getName() + "§e(" + jogador.getUniqueId() + "§e)");
            ...
            if (kit.equalsIgnoreCase("Monk")) {
                p.sendMessage("§eO Kit §bMONK §eFoi dado ao jogador " + jogador.getName() + "§e(" + jogador.getUniqueId() + "§e)");
            ...
            if (kit.equalsIgnoreCase("Camel")) {
                p.sendMessage("§eO Kit §bCAMEL §eFoi dado ao jogador " + jogador.getName() + "§e(" + jogador.getUniqueId() + "§e)");
            ...
            if (kit.equalsIgnoreCase("Deshfire")) {
                p.sendMessage("§eO Kit §bDESHFIRE §eFoi dado ao jogador " + jogador.getName() + "§e(" + jogador.getUniqueId() + "§e)");
            ...
            if (kit.equalsIgnoreCase("Deshviper")) {
                p.sendMessage("§eO Kit §bDESHVIPER §eFoi dado ao jogador " + jogador.getName() + "§e(" + jogador.getUniqueId() + "§e)");
            ...
            if (kit.equalsIgnoreCase("Fisherman")) {
                p.sendMessage("§eO Kit §bFISHERMAN §eFoi dado ao jogador " + jogador.getName() + "§e(" + jogador.getUniqueId() + "§e)");
            ...
            if (kit.equalsIgnoreCase("Forcefield")) {
                p.sendMessage("§eO Kit §bFORCEFIELD §eFoi dado ao jogador " + jogador.getName() + "§e(" + jogador.getUniqueId() + "§e)");
            ...
            if (kit.equalsIgnoreCase("Gladiator")) {
                p.sendMessage("§eO Kit §bGLADIATOR §eFoi dado ao jogador " + jogador.getName() + "§e(" + jogador.getUniqueId() + "§e)");
            ...
            if (kit.equalsIgnoreCase("Hulk")) {
                p.sendMessage("§eO Kit §bHULK §eFoi dado ao jogador " + jogador.getName() + "§e(" + jogador.getUniqueId() + "§e)");
            ...
            if (kit.equalsIgnoreCase("Kangaroo")) {
                p.sendMessage("§eO Kit §bKANGAROO §eFoi dado ao jogador " + jogador.getName() + "§e(" + jogador.getUniqueId() + "§e)");
