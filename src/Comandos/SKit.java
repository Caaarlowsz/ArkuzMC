        ...
        if (Label.equalsIgnoreCase("skit") && Sender instanceof Player) {
            ...
            if (Args[0].equalsIgnoreCase("criar")) {
                ...
                if (this.isInt(Args[2])) {
                    ...
                    Bukkit.getServer().broadcastMessage(String.valueOf(Main.prefix) + " §4\u27bc §7O Kit §c" + nome + " §7Foi Aplicado Em Um Raio De §c" + n + " §7Blocos");
                    Bukkit.getServer().broadcastMessage("");
                    p.sendMessage(String.valueOf(Main.prefix) + " §4\u27bc §7Voc\u00ea Aplicou o Kit §c" + nome + " §7Em Um Raio De §c" + n + " §7Blocos");
                    return true;
                }
            }
        }
