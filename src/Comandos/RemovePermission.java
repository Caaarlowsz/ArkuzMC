...
public class RemovePermission implements CommandExecutor, Listener {
    public boolean onCommand(final CommandSender sender, final Command cmd, final String label, final String[] args) {
        ...
        if (cmd.getName().equalsIgnoreCase("removepermission")) {
            ...
            if (args.length != 2) {
                p.sendMessage(String.valueOf(ArkuzPvP.prefix) + "➼ §cEssa Permissão não existe!");
                return true;
            }
            ...
            if (permissions.equalsIgnoreCase("Admin")) {
                ...
                jogador.sendMessage(
                        String.valueOf(ArkuzPvP.prefix) + " ➼ §cVoce perdeu a Permissão Para o §fModo Admin§c!");
            ...
            if (permissions.equalsIgnoreCase("staffchat")) {
                ...
                jogador.sendMessage(
                        String.valueOf(ArkuzPvP.prefix) + " ➼ §cVoce perdeu a Permissao do §fSstaffChat§c!");
                Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
                        "pex user " + jogador.getName() + " remove arkuz.sc");
                return true;
            }
            if (permissions.equalsIgnoreCase("fullkit")) {
                p.sendMessage(String.valueOf(ArkuzPvP.prefix) + " ➼ §aVoce removeu Todos os Kits Ao jogador §f"
                        + jogador.getName());
                jogador.sendMessage(
                        String.valueOf(ArkuzPvP.prefix) + " ➼ §cVoce perdeu a Permissão de §fTodos os Kits§c!");
            ...
            if (permissions.equalsIgnoreCase("teleportar")) {
                p.sendMessage(String.valueOf(ArkuzPvP.prefix)
                        ...
                        + jogador.getName());
                jogador.sendMessage(
                        String.valueOf(ArkuzPvP.prefix) + " ➼ §cVoce perdeu a Permissão de §fTeleportar§c!");
                Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
            ...
            if (permissions.equalsIgnoreCase("givevips")) {
                ...
                jogador.sendMessage(
                        String.valueOf(ArkuzPvP.prefix) + " ➼ §aVoce perdeu a Permissão de §fDar Vips§c!");
                Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
            ...
            if (permissions.equalsIgnoreCase("givekit")) {
                ...
                jogador.sendMessage(
                        String.valueOf(ArkuzPvP.prefix) + "➼ §cVoce perdeu a Permissão de §fDar Kits§c!");
                Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
            ...
            if (permissions.equalsIgnoreCase("sortearkit")) {
                p.sendMessage(String.valueOf(ArkuzPvP.prefix)
                        ...
                        + jogador.getName());
                jogador.sendMessage(
                        String.valueOf(ArkuzPvP.prefix) + "➼ §cVoce perdeu a Permissao de §fSortear kits§c!");
                Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
            ...
            if (permissions.equalsIgnoreCase("sortearvip")) {
                p.sendMessage(String.valueOf(ArkuzPvP.prefix)
                        ...
                        + jogador.getName());
                jogador.sendMessage(
                        String.valueOf(ArkuzPvP.prefix) + " ➼ §aVoce perdeu a Permissao de §fSortear Vips§c!");
                Bukkit.dispatchCommand((CommandSender) Bukkit.getConsoleSender(),
