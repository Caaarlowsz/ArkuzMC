...
public class KitAPI implements Listener
{
    ...
    public static void QUARTZ(final Player p) {
    }
    
    public static void setKit(final Player p, final String string) {
    }
    
    public static ItemStack criarItem(final Player p, final Material cobblestone, final String string, final Object object) {
        return null;
    }
}
