...
public class InvRanks implements Listener, CommandExecutor
{
    public static void guiKits(final Player p) {
        ...
        final ArrayList descevent112 = new ArrayList();
        ...
        final ArrayList descevent113 = new ArrayList();
        ...
        final ArrayList descevent114 = new ArrayList();
        ...
        final ArrayList descevent115 = new ArrayList();
        ...
        final ArrayList descevent116 = new ArrayList();
        ...
        final ArrayList descevent117 = new ArrayList();
        ...
        final ArrayList descevent118 = new ArrayList();
        event19.setItemMeta(eventv19);
        inv.setItem(34, event19);
        ItemStack[] arrayOfItemStack;
        for (int descpyro11 = (arrayOfItemStack = inv.getContents()).length, metapyro1 = 0; metapyro1 < descpyro11; ++metapyro1) {
    ...
    public void onPlayerCLickInventry(final InventoryClickEvent e) {
        ...
        if (e.getInventory().getTitle().equalsIgnoreCase("§8{ §cRanks §8}") && e.getCurrentItem() != null && e.getCurrentItem().getTypeId() != 0) {
            e.setCancelled(true);
            if (e.getSlot() == 12) {
                e.setCancelled(true);
                p.closeInventory();
