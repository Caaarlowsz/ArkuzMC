...
public class irWarp implements CommandExecutor, Listener
{
    public boolean onCommand(final CommandSender sender, final Command cmd, final String commandLabel, final String[] args) {
        ...
        if (cmd.getName().equalsIgnoreCase("warp") && args.length == 0) {
            p.sendMessage(String.valueOf(Main.prefix) + " §4\u27bc §7Use: /Warp {Warp}");
            return true;
        }
        if (args[0].equalsIgnoreCase("challenge")) {
            if (Main.getInstance().warps.getConfigurationSection("challenge") == null) {
                p.sendMessage(String.valueOf(Main.prefix) + " §4\u27bc §7Warp Challenge Ainda N\u00e3o Foi Setada");
                return true;
            }
            ...
            p.sendMessage(String.valueOf(Main.prefix) + " §4\u27bc §7Voc\u00ea Foi Teleportado Para: §cLava Challenge");
            ...
            if (Main.getInstance().warps.getConfigurationSection("fps") == null) {
                p.sendMessage(String.valueOf(Main.prefix) + " §4\u27bc §7Warp FPS Ainda N\u00e3o Foi Setada");
                return true;
            }
            ...
            p.getInventory().clear();
            p.setHealth(20.0);
            p.sendMessage(String.valueOf(Main.prefix) + " §4\u27bc §7Voc\u00ea Foi Teleportado Para: §cFps");
            TheTitle.sendTitle(p, Main.prefix);
            ...
            if (Main.getInstance().warps.getConfigurationSection("main") == null) {
                p.sendMessage(String.valueOf(Main.prefix) + " §4\u27bc §7Warp Main Ainda N\u00e3o Foi Setada");
                return true;
            }
            ...
            Habilidade.removeAbility(p);
            p.getInventory().clear();
            p.sendMessage(String.valueOf(Main.prefix) + " §4\u27bc §7Voc\u00ea Foi Teleportado Para: §cMain");
            TheTitle.sendTitle(p, Main.prefix);
            ...
            if (args[0].equalsIgnoreCase("gladiator")) {
                p.sendMessage(String.valueOf(Main.prefix) + " §4\u27bc §7Warp gladiator est\u00e1 em desenvolvimento...");
                return true;
            }
            if (args[0].equalsIgnoreCase("knock")) {
                if (Main.getInstance().warps.getConfigurationSection("knock") == null) {
                    p.sendMessage(String.valueOf(Main.prefix) + " §4\u27bc §7Warp Knock Ainda N\u00e3o Foi Setada");
                    return true;
                }
                ...
                p.getInventory().clear();
                p.setGameMode(GameMode.SURVIVAL);
                p.sendMessage(String.valueOf(Main.prefix) + " §4\u27bc §7Voc\u00ea Foi Teleportado Para: §cKnock");
                TheTitle.sendTitle(p, Main.prefix);
                TheTitle.sendSubTitle(p, "§7§lKNOCK");
                Habilidade.setAbility(p, "Knock");
                p.setFireTicks(0);
                p.setHealth(20.0);
                KitUtil.darItemEnchant(p, Material.STICK, 1, "§aVaret\u00e3o", 0, Enchantment.KNOCKBACK, 5, true);
                KitUtil.tirarEfeitos(p);
                KitUtil.tirarArmadura(p);
                p.setAllowFlight(false);
                p.updateInventory();
                ...
                if (Main.getInstance().warps.getConfigurationSection("textura") == null) {
                    p.sendMessage(String.valueOf(Main.prefix) + " §4\u27bc §7Warp Textura Ainda N\u00e3o Foi Setada");
                    return true;
                }
                final World w = Bukkit.getServer().getWorld(Main.getInstance().warps.getString("textura.world"));
                final double x = Main.getInstance().warps.getDouble("textura.x");
                final double y = Main.getInstance().warps.getDouble("textura.y");
                final double z = Main.getInstance().warps.getDouble("textura.z");
                final Location lobby = new Location(w, x, y, z);
                lobby.setPitch((float)Main.getInstance().warps.getDouble("textura.pitch"));
                lobby.setYaw((float)Main.getInstance().warps.getDouble("textura.yaw"));
                p.teleport(lobby);
                Habilidade.removeAbility(p);
                p.getInventory().clear();
                p.setGameMode(GameMode.SURVIVAL);
                p.sendMessage(String.valueOf(Main.prefix) + " §4\u27bc §7Voc\u00ea Foi Teleportado Para: §cTextura");
                TheTitle.sendTitle(p, Main.prefix);
                ...
                if (Main.getInstance().warps.getConfigurationSection("mdr") == null) {
                    p.sendMessage(String.valueOf(Main.prefix) + " §4\u27bc §7Warp Mdr Ainda N\u00e3o Foi Setada");
                    return true;
                }
                ...
                Habilidade.removeAbility(p);
                p.getInventory().clear();
                p.sendMessage(String.valueOf(Main.prefix) + " §4\u27bc §7Voc\u00ea Foi Teleportado Para: §cMdr");
                TheTitle.sendTitle(p, Main.prefix);
                ...
                if (Main.getInstance().warps.getConfigurationSection("rdm") == null) {
                    p.sendMessage(String.valueOf(Main.prefix) + " §4\u27bc §7Warp Rdm Ainda N\u00e3o Foi Setada");
                    return true;
                }
                ...
                p.setHealth(20.0);
                p.setGameMode(GameMode.SURVIVAL);
                p.sendMessage(String.valueOf(Main.prefix) + " §4\u27bc §7Voc\u00ea Foi Teleportado Para: §cRdm");
                TheTitle.sendTitle(p, Main.prefix);
