...
public class Swords implements Listener
{
    ...
    public void SwordKit(final PlayerInteractEvent e) {
        ...
        if (Habilidade.getAbility(player) == "Swords" && (player.getItemInHand().getType() == Material.WOOD_SWORD || player.getItemInHand().getType() == Material.GOLD_SWORD || player.getItemInHand().getType() == Material.STONE_SWORD || player.getItemInHand().getType() == Material.IRON_SWORD)) {
