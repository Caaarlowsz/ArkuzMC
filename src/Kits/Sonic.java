...
public class Sonic implements Listener
{
    ...
    static {
        Kits.Sonic.Sonic = new ArrayList<String>();
        Kits.Sonic.Armadura = new HashMap<String, ItemStack[]>();
        Kits.Sonic.saveinv = new HashMap<String, ItemStack[]>();
        Kits.Sonic.armadura = new HashMap<String, ItemStack[]>();
        Kits.Sonic.Armadura2 = new HashMap<String, ItemStack[]>();
    ...
    public void SonicLick(final PlayerInteractEvent event) {
        ...
        if (event.getPlayer().getItemInHand().getType() == Material.LAPIS_BLOCK && KitAPI.Sonic.contains(event.getPlayer().getName())) {
            ...
            Kits.Sonic.Armadura.put(p.getName(), p.getInventory().getArmorContents());
