        ...
        if (Habilidade.getAbility(p).equalsIgnoreCase("C4")) {
            if (e.getAction() == Action.RIGHT_CLICK_AIR || e.getAction() == Action.RIGHT_CLICK_BLOCK) {
                if (p.getItemInHand().getType() == Material.SLIME_BALL) {
                    ...
                    itembm.setDisplayName(String.valueOf(Main.prefix) + " §4\u27bc §7Kit §cC4");
                    itemb.setItemMeta(itembm);
                    p.getInventory().setItemInHand(itemb);
                    p.updateInventory();
                    p.sendMessage(String.valueOf(Main.prefix) + " §4\u27bc §7Bomba Implantada");
                }
                    ...
                    itembm2.setDisplayName("§7Kit §cC4");
                    ...
                    item2.remove();
                    p.updateInventory();
                    p.sendMessage(String.valueOf(Main.prefix) + " §4\u27bc §7Bomba Explodida");
                    Cooldown.add(p, 20);
                ...
                final ItemStack itemb2 = new ItemStack(Material.SLIME_BALL);
                final ItemMeta itembm2 = itemb2.getItemMeta();
                itembm2.setDisplayName(String.valueOf(Main.prefix) + " §4\u27bc §7Kit §cC4");
                itemb2.setItemMeta(itembm2);
                p.getInventory().setItemInHand(itemb2);
                final Item item2 = C4.bomba.get(p.getName());
                C4.bomba.remove(p.getName());
                item2.remove();
                p.updateInventory();
                p.sendMessage(String.valueOf(Main.prefix) + " §4\u27bc §7Bomba Desarmada");
            }
        }
    }
