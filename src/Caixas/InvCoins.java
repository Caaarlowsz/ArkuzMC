...
public class InvCoins implements Listener, CommandExecutor
{
    public static void guiKits(final Player p) {
        final Inventory inv = Bukkit.getServer().createInventory((InventoryHolder)p, 54, "§8{ §cCoins §8}");
        ...
        event451v.setDisplayName("§7{ §c500 Coins §7}");
        ...
        event456v.setDisplayName("§7{ §c1000 Coins §7}");
        ...
        eventv.setDisplayName("§7{ §c1500 Coins §7}");
        ...
        eventv2.setDisplayName("§7{ §c800 Coins §7}");
        ...
        eventv3.setDisplayName("§7{ §c400 Coins §7}");
        ...
        eventv4.setDisplayName("§7{ §c300 Coins §7}");
        ...
        eventv5.setDisplayName("§7{ §c200 Coins §7}");
        ...
        eventv6.setDisplayName("§7{ §c100 Coins §7}");
        ...
        eventv7.setDisplayName("§7{ §c1100 Coins §7}");
        ...
        eventv8.setDisplayName("§7{ §c1200 Coins §7}");
        ...
        eventv9.setDisplayName("§7{ §c1300 Coins §7}");
        ...
        eventv10.setDisplayName("§7{ §c1400 Coins §7}");
        ...
        eventv11.setDisplayName("§7{ §c1500 Coins §7}");
        ...
        eventv12.setDisplayName("§7{ §c2000 Coins §7}");
        ...
        eventv13.setDisplayName("§7{ §c4000 Coins §7}");
    ...
    public void onPlayerCLickInventry(final InventoryClickEvent e) {
        ...
        if (e.getInventory().getTitle().equalsIgnoreCase("§8{ §cCoins §8}") && e.getCurrentItem() != null && e.getCurrentItem().getTypeId() != 0) {
            e.setCancelled(true);
            if (e.getSlot() == 12) {
                return;
            }
